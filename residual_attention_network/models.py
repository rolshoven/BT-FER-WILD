...
from residual_attention_network.blocks import residual_block
from residual_attention_network.blocks import attention_block
...
def AttentionResNet56(shape=(224, 224, 3), n_channels=64, n_classes=100, dropout=0, regularization=0.01):
    """
    Attention-56 ResNet
    https://arxiv.org/abs/1704.06904
    """
